...
if __name__ == '__main__':
	...
	for url in urls[start:end]:
		...
		if quick_mode:
			try:
				response = get_request_response('https://%s-ae.sssports.com/' %language + url['url'])
			...
			for store in ['ae', 'sa', 'kw', 'qa']#, 'int']:
				#if store == 'int': server = 'https://sssports.com/'
				else: server = 'https://%s-%s.sssports.com/' % (language, store)
