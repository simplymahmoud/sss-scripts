...
class TestBlocks(BaseTest):
    ...
    def test001_get_blocks(self):
        """ TestCase-4: Test case for test get /blocks.*
        **Test Scenario:**
    ...
    def test002_get_block(self):
        """ TestCase-5: Test case for test get /blocks/{id}.*
        **Test Scenario:**
