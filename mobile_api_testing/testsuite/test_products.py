...
products_response_headers = {'Transfer-Encoding': 'chunked', 
...
products = {
        ...
        "relationships": {
            "images": {
                ...
                "links": {
                    "self": "http://45.33.59.76/api/v1/products/157414/relationships/images",
                    "related": "http://45.33.59.76/api/v1/products/157414/images"
                }
            },
            "selections": {
                "data": [
                ...
                "links": {
                    "self": "http://45.33.59.76/api/v1/products/157414/relationships/selections",
                    "related": "http://45.33.59.76/api/v1/products/157414/selections"
                }
            },
            "children": {
                "data": [
                ...
                "links": {
                    "self": "http://45.33.59.76/api/v1/products/157414/relationships/children",
                    "related": "http://45.33.59.76/api/v1/products/157414/children"
                }
            },
            "config": {
                "data": [],
                "links": {
                    "self": "http://45.33.59.76/api/v1/products/157414/relationships/config",
                    "related": "http://45.33.59.76/api/v1/products/157414/config"
                }
            }
        },
        "links": {
            "self": "http://45.33.59.76/api/v1/products/157414"
        }
    }
...
class TestBrands(BaseTest):
    ...
    def test001_get_products(self):
        """ TestCase-10: Test case for test get /products.*
        **Test Scenario:**
    ...
    def test002_get_product(self):
        """ TestCase-11: Test case for test get /products/{id}.*
        **Test Scenario:**
